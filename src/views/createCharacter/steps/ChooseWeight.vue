<template>
  ...
  <ion-fab slot="fixed" vertical="bottom" horizontal="end" @click="onChooseWeight(inputWeight)">
...
import backgroundImage from "@/static/images/backgrounds/image_SELECT_WEIGHT.png";
import {ref} from "vue";
