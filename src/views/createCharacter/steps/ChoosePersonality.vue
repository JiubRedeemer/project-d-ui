<template>
  ...
  <div class="wrapper">
    <div class="image-wrapper">
      ...
      <img :src="`src/static/images/backgrounds/image_SELECT_PERSONALITY.png`" class="background-large-image"
    ...
    <ion-textarea
        ...
        fill="outline"
        color="primary"
        :placeholder="TEXTS.whatIsYourPersonality.rus"
        :clear-input="true"
        v-model="inputPersonality"
        class="input-block"
        :rows="15"
    ></ion-textarea>
  </div>

  <ion-fab slot="fixed" vertical="bottom" horizontal="end" @click="onChoosePersonality(inputPersonality)">
...
function onChoosePersonality(personality: string) {
  if (personality != null && personality.length > 0) {
    if (props.characterData) {
      // eslint-disable-next-line vue/no-mutating-props
      props.characterData.personality = personality;
    }
