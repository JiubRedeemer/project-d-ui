<template>
  ...
  <div class="wrapper">
    <div class="image-wrapper">
      ...
      <img :src="`src/static/images/backgrounds/image_SELECT_WEAKNESSES.png`" class="background-large-image"
  ...
  <ion-fab slot="fixed" vertical="bottom" horizontal="end" @click="onChooseWeaknesses(inputWeaknesses)">
