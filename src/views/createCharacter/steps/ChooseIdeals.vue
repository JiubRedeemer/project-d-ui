<template>
  ...
  <div class="wrapper">
    <div class="image-wrapper">
      ...
      <img :src="`src/static/images/backgrounds/image_SELECT_IDEALS.png`" class="background-large-image"
    ...
    <ion-textarea
        ...
        fill="outline"
        color="primary"
        :placeholder="TEXTS.whatIsYourIdeals.rus"
        :clear-input="true"
        v-model="inputIdeals"
        class="input-block"
        :rows="15"
  ...
  <ion-fab slot="fixed" vertical="bottom" horizontal="end" @click="onChooseIdeals(inputIdeals)">
...
function onChooseIdeals(ideals: string) {
  if (ideals != null && ideals.length > 0) {
    if (props.characterData) {
      // eslint-disable-next-line vue/no-mutating-props
      props.characterData.ideals = ideals;
    }
