<template>
  ...
  <div class="wrapper">
    <div class="image-wrapper">
      ...
      <img :src="`src/static/images/backgrounds/image_SELECT_HISTORY.png`" class="background-large-image"
    ...
    <ion-textarea
        ...
        fill="outline"
        color="primary"
        :placeholder="TEXTS.whatIsYourHistory.rus"
        :clear-input="true"
  ...
  <ion-fab slot="fixed" vertical="bottom" horizontal="end" @click="onChooseHistory(inputHistory)">
...
function onChooseHistory(history: string) {
  if (history != null && history.length > 0) {
    if (props.characterData) {
      // eslint-disable-next-line vue/no-mutating-props
      props.characterData.history = history;
    }
