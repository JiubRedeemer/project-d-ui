...
function validate() {
  ...
  if (matchingPassword.value !== localStorage.getItem("userPassword")) {
    errors.value.push({
      color: 'danger',
    ...
    <ion-content class="ion-padding">
      <div class="wrapper">
        <div class="input-block">
          <h1 class="input-header">Введите пароль еще раз</h1>
          <div class="button-block">
            <ion-input type="password" fill="outline" color="tertiary"
                       placeholder="Пароль" :clear-input="true" v-model="matchingPassword"></ion-input>
