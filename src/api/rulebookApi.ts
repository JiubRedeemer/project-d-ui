...
export async function getGroupedRacesForRoom(roomId: string): Promise<RaceGroupDto[]> {
...
export async function getRacesForRoom(roomId: string): Promise<RaceCreateInfoDto[]> {
  const { data } = await axios.get<RaceCreateInfoDto[]>(
...
export async function getRootRacesForRoom(roomId: string): Promise<RaceDto[]> {
...
export async function getClassesForRoom(roomId: string): Promise<ClassCreateInfoDto[]> {
  const { data } = await axios.get<ClassCreateInfoDto[]>(
...
export async function getRootClassesForRoom(roomId: string): Promise<ClazzDto[]> {
